        ...
        <div class="flex gap-12 items-start">
            ...
            <article class="flex-1 min-w-0 max-w-3xl">
                ...
                <div class="space-y-10">
                    ...
                    {{-- 1 --}}
                    <section id="acceptance" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                    ...
                    {{-- 2 --}}
                    <section id="description" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                    ...
                    {{-- 3 --}}
                    <section id="accounts" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                    ...
                    {{-- 4 --}}
                    <section id="billing" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                        ...
                        <div class="text-sm leading-relaxed text-gray-700 space-y-4">
                            <div>
                                <h3 class="font-semibold text-gray-900 mb-2">Subscription Plans</h3>
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 mb-2">Auto-Renewal</h3>
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 mb-2">Cancellation</h3>
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 mb-2">Price Changes</h3>
                    ...
                    {{-- 5 --}}
                    <section id="acceptable" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                        ...
                        <div class="text-sm leading-relaxed text-gray-700 space-y-4">
                            ...
                            <div class="bg-red-50 border border-red-100 rounded-xl p-5 space-y-2">
                                @php $prohibited = [
                                ...
                                <div class="flex items-start gap-2">
                                    ...
                                    <span class="text-red-800">{{ $p }}</span>
                                </div>
                                @endforeach
                            </div>
                    ...
                    {{-- 6 --}}
                    <section id="your-content" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                    ...
                    {{-- 7 --}}
                    <section id="ip" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                    ...
                    {{-- 8 --}}
                    <section id="privacy" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                    ...
                    {{-- 9 --}}
                    <section id="disclaimers" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                    ...
                    {{-- 10 --}}
                    <section id="liability" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                    ...
                    {{-- 11 --}}
                    <section id="indemnity" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                    ...
                    {{-- 12 --}}
                    <section id="termination" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                    ...
                    {{-- 13 --}}
                    <section id="governing-law" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                    ...
                    <section id="contact" class="bg-white rounded-2xl border border-gray-100 p-8 scroll-mt-24">
                        ...
                        <div class="text-sm leading-relaxed text-gray-700 space-y-3">
                            ...
                            <div class="bg-gray-50 rounded-xl p-5 mt-3">
                                ...
                                <p class="text-gray-600">Legal Inquiries</p>
                ...
                <div class="mt-8 bg-blue-50 border border-blue-100 rounded-2xl p-6 flex items-center justify-between gap-4 flex-wrap">
                    <div>
                        <p class="font-semibold text-gray-900 text-sm">Also see our Privacy Policy</p>
                        <p class="text-gray-500 text-xs mt-1">How we collect, use, and protect your data.</p>
                    </div>
