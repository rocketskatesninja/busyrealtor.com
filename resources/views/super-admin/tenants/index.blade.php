...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        <form method="GET" class="flex flex-wrap gap-3 items-end">
            ...
            <select name="plan" class="border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none">
            ...
            <select name="status" class="border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none">
            ...
            <a href="{{ route('super.tenants') }}" class="text-sm text-gray-500 py-2.5">Clear</a>
            @endif
        </form>
    </div>
