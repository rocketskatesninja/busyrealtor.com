...
(function () {
    ...
    <button @click="$store.theme.toggle()" :style="$store.theme.dark ? 'background:#ffffff;border-color:#d1d5db;color:#374151' : 'background:#1e293b;border-color:#475569;color:#e2e8f0'" class="fixed bottom-4 right-4 z-50 p-2.5 rounded-full border shadow-lg hover:shadow-xl transition" title="Toggle dark mode">
